...
export const LandingPage: React.FC<LandingPageProps> = ({ onLogin }) => {
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-purple-50/50 to-teal-50/40 flex flex-col font-sans text-slate-900">
      {/* Navigation */}
      <nav className="sticky top-0 z-50 bg-white/90 backdrop-blur-xl border-b border-emerald-100/50 shadow-sm">
        <div className="container mx-auto px-4 sm:px-6 h-16 sm:h-20 flex items-center justify-between">
          ...
          <div className="hidden lg:flex items-center gap-8 text-sm font-medium text-slate-600">
            ...
            <a href="#solution" className="hover:text-blue-600 transition-colors">The Solution</a>
            <a href="#proof" className="hover:text-blue-600 transition-colors">Proof</a>
            <a href="#pricing" className="hover:text-blue-600 transition-colors">Investment</a>
          </div>
          <div className="flex items-center gap-2 sm:gap-4">
            <Button variant="ghost" onClick={onLogin} className="font-semibold text-xs sm:text-sm text-slate-700 hover:text-blue-600 px-2 sm:px-4">
              Log In
            </Button>
            <Button onClick={onLogin} className="bg-gradient-to-r from-blue-600 via-purple-600 to-teal-600 hover:from-emerald-700 hover:via-teal-700 hover:to-slate-800 text-white shadow-lg shadow-blue-500/30 rounded-full px-3 sm:px-6 text-xs sm:text-sm font-bold relative overflow-hidden group">
      ...
      <header className="relative pt-12 sm:pt-20 pb-12 sm:pb-16 overflow-hidden">
        ...
        <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_top_right,_var(--tw-gradient-stops))] from-blue-100/40 via-purple-50/30 to-transparent opacity-70"></div>
        <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_bottom_left,_var(--tw-gradient-stops))] from-purple-100/30 via-transparent to-transparent opacity-50"></div>

        {/* Floating elements */}
        <div className="absolute top-20 left-10 w-32 h-32 bg-gradient-to-br from-blue-400/15 to-purple-400/15 rounded-full blur-3xl animate-float"></div>
        <div className="absolute bottom-20 right-10 w-40 h-40 bg-gradient-to-br from-purple-400/15 to-teal-400/15 rounded-full blur-3xl animate-float-delayed"></div>

        <div className="container mx-auto px-4 sm:px-6 relative z-10">
          {/* Attention-grabbing badge */}
          <div className="text-center mb-6 sm:mb-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
            <div className="inline-flex items-center gap-2 sm:gap-3 bg-gradient-to-r from-blue-50 to-purple-50 border-2 border-blue-200/50 rounded-full px-3 sm:px-6 py-2 sm:py-2.5 shadow-lg shadow-blue-500/10">
              <Crown className="w-4 h-4 sm:w-5 sm:h-5 text-blue-600 animate-pulse" />
              <span className="text-[10px] sm:text-sm font-bold bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent uppercase tracking-wide">
          ...
          <p className="text-base sm:text-xl md:text-2xl text-slate-700 mb-4 sm:mb-6 max-w-4xl mx-auto leading-relaxed text-center font-semibold animate-in fade-in slide-in-from-bottom-8 duration-700 delay-200">
            ...
            <span className="text-blue-600"> faster, cheaper, and without the drama.</span>
          </p>
          ...
          <p className="text-sm sm:text-lg text-slate-600 mb-8 sm:mb-12 max-w-3xl mx-auto text-center animate-in fade-in slide-in-from-bottom-8 duration-700 delay-300">
            <span className="font-bold text-slate-800">Warning:</span> This is NOT another "AI chatbot." This is a complete workforce replacement that <span className="underline decoration-blue-400 decoration-2">actually does the work</span>—not just talks about it.
          </p>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-4 mb-4 sm:mb-6 animate-in fade-in slide-in-from-bottom-8 duration-700 delay-400 px-4">
            <Button
              onClick={onLogin}
              size="lg"
              className="w-full sm:w-auto bg-gradient-to-r from-blue-600 via-purple-600 to-teal-600 hover:from-emerald-700 hover:via-teal-700 hover:to-slate-800 text-white shadow-2xl shadow-purple-500/30 rounded-full px-6 sm:px-10 h-12 sm:h-16 text-base sm:text-xl font-black relative overflow-hidden group"
            >
            ...
            <Button
              variant="outline"
              size="lg"
              className="w-full sm:w-auto rounded-full px-6 sm:px-10 h-12 sm:h-16 text-base sm:text-xl font-bold border-2 border-blue-300 hover:bg-blue-50 text-slate-800 shadow-lg"
            >
          ...
          <div className="text-center text-xs sm:text-sm text-slate-600 animate-in fade-in slide-in-from-bottom-8 duration-700 delay-500 px-4">
            ...
            <p className="font-medium">
              <span className="font-bold text-blue-600">487 agencies</span> have already replaced their fulfillment teams
            </p>
          </div>
          ...
          <div className="mt-12 sm:mt-20 relative max-w-6xl mx-auto animate-in fade-in slide-in-from-bottom-12 duration-1000 delay-600 px-4">
            <div className="absolute -inset-4 sm:-inset-6 bg-gradient-to-r from-blue-500 via-purple-500 to-teal-500 rounded-2xl sm:rounded-3xl opacity-30 blur-3xl animate-pulse-slow"></div>
      ...
      <section id="solution" className="py-12 sm:py-24 bg-gradient-to-br from-blue-50/60 via-purple-50/40 to-teal-50/30 relative overflow-hidden">
        <div className="absolute inset-0 bg-[url('/grid.svg')] opacity-5"></div>

        <div className="container mx-auto px-4 sm:px-6 relative z-10">
          <div className="text-center mb-12 sm:mb-20">
            <div className="inline-block bg-gradient-to-r from-blue-100 to-purple-100 border border-blue-200 rounded-full px-4 sm:px-6 py-1.5 sm:py-2 mb-4 sm:mb-6">
              <span className="text-xs sm:text-sm font-bold text-blue-700 uppercase tracking-wide">Introducing The Solution</span>
            </div>
          ...
          <div className="space-y-16 sm:space-y-32 max-w-7xl mx-auto">
            ...
            <div className="flex flex-col lg:flex-row items-center gap-8 sm:gap-12">
              <div className="flex-1 space-y-4 sm:space-y-6 order-2 lg:order-1">
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 sm:w-14 sm:h-14 bg-gradient-to-br from-blue-500 to-purple-500 rounded-xl sm:rounded-2xl flex items-center justify-center text-white shadow-lg shadow-blue-500/30">
                    <Globe className="w-5 h-5 sm:w-7 sm:h-7" />
                  </div>
                  <span className="inline-block bg-blue-100 text-blue-700 text-xs font-bold px-3 py-1 rounded-full uppercase tracking-wide">Agent #1</span>
                </div>
                ...
                <div className="bg-white/80 backdrop-blur-sm p-4 sm:p-6 rounded-xl sm:rounded-2xl border border-blue-200/50 shadow-lg">
                  <div className="flex items-start gap-3">
                    <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-full bg-gradient-to-br from-blue-400 to-purple-400 flex-shrink-0"></div>
                    <div>
              ...
              <div className="flex-1 order-1 lg:order-2 w-full">
                <div className="relative group">
                  <div className="absolute -inset-2 sm:-inset-4 bg-gradient-to-r from-blue-500 to-purple-500 rounded-xl sm:rounded-2xl opacity-20 group-hover:opacity-30 blur-2xl transition-opacity"></div>
            ...
            <div className="flex flex-col lg:flex-row-reverse items-center gap-8 sm:gap-12">
              <div className="flex-1 space-y-4 sm:space-y-6 order-2">
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 sm:w-14 sm:h-14 bg-gradient-to-br from-teal-500 to-green-500 rounded-xl sm:rounded-2xl flex items-center justify-center text-white shadow-lg shadow-teal-500/30">
                    <Rocket className="w-5 h-5 sm:w-7 sm:h-7" />
                  </div>
                  <span className="inline-block bg-teal-100 text-teal-700 text-xs font-bold px-3 py-1 rounded-full uppercase tracking-wide">Bonus</span>
                </div>
                <h3 className="text-2xl sm:text-3xl md:text-4xl font-black text-slate-900">
                ...
                <div className="space-y-3 sm:space-y-4 pt-2 sm:pt-4">
                  {[
                    ...
                    <div key={i} className="flex items-start gap-3 group">
                      ...
                      <div>
                        <span className="text-sm sm:text-base text-slate-800 font-medium">{benefit.text}</span>
                        <div className="text-xs sm:text-sm text-blue-600 font-bold mt-1">{benefit.metric}</div>
                      </div>
                    </div>
                  ))}
                </div>
              ...
              <div className="flex-1 order-1 w-full">
                <div className="relative group">
                  <div className="absolute -inset-2 sm:-inset-4 bg-gradient-to-r from-teal-500 to-green-500 rounded-xl sm:rounded-2xl opacity-20 group-hover:opacity-30 blur-2xl transition-opacity"></div>
                  <div className="relative rounded-xl sm:rounded-2xl overflow-hidden shadow-2xl border-2 border-white/50 bg-white/80 backdrop-blur-sm transform group-hover:scale-[1.02] transition-transform duration-300">
                      <div className="aspect-video bg-gradient-to-br from-teal-50 to-green-50 flex items-center justify-center">
                      <div className="text-center p-8">
                        <Rocket className="w-16 h-16 sm:w-24 sm:h-24 text-teal-400 mx-auto mb-4" />
                        <p className="text-sm sm:text-base text-blue-600 font-bold">Agent Marketplace</p>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8 max-w-6xl mx-auto mb-12 sm:mb-16">
            {[
              ...
              <div key={i} className="text-center group">
                <div className="bg-gradient-to-br from-blue-50 to-purple-50 p-6 sm:p-8 rounded-2xl border-2 border-blue-200/50 group-hover:border-purple-400 transition-all duration-300 group-hover:shadow-xl group-hover:shadow-purple-500/20">
                  <div className="text-3xl sm:text-5xl font-black bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent mb-2">
      ...
      <section id="pricing" className="py-12 sm:py-24 bg-gradient-to-br from-blue-600 via-purple-600 to-indigo-600 text-white relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 sm:px-6 relative z-10">
          <div className="text-center mb-12 sm:mb-16">
            ...
            <p className="text-lg sm:text-2xl text-blue-100 max-w-3xl mx-auto mb-4">
              ...
              <div className="text-center mb-8 sm:mb-12">
                ...
                <div className="mb-6">
                  <div className="text-4xl sm:text-6xl md:text-7xl font-black mb-2">
                    $497<span className="text-2xl sm:text-3xl md:text-4xl text-blue-200">/mo</span>
                  </div>
                  <div className="text-base sm:text-xl text-purple-100">
      ...
      {/* Final CTA Section */}
      <section className="py-16 sm:py-24 bg-gradient-to-br from-blue-600 via-purple-600 to-teal-600 text-white relative overflow-hidden">
        <div className="absolute inset-0 bg-[url('/grid.svg')] opacity-10"></div>
      ...
      {/* Footer */}
      <footer className="bg-slate-100 text-slate-600 py-8 sm:py-12">
        <div className="container mx-auto px-4 sm:px-6">
          <div className="grid sm:grid-cols-2 md:grid-cols-4 gap-8 mb-8">
            <div>
              <h3 className="font-bold text-slate-900 text-sm sm:text-base mb-3 sm:mb-4">Product</h3>
            ...
            <div>
              <h3 className="font-bold text-slate-900 text-sm sm:text-base mb-3 sm:mb-4">Company</h3>
              <ul className="space-y-2 text-xs sm:text-sm">
            ...
            <div>
              <h3 className="font-bold text-slate-900 text-sm sm:text-base mb-3 sm:mb-4">Resources</h3>
              <ul className="space-y-2 text-xs sm:text-sm">
            ...
            <div>
              <h3 className="font-bold text-slate-900 text-sm sm:text-base mb-3 sm:mb-4">Legal</h3>
              <ul className="space-y-2 text-xs sm:text-sm">
